...
async function saveSettings(e) {
    ...
    cfg.alexa.invocation_name =
        document.getElementById('cfg-alexa-invocation')?.value.trim().toLowerCase() || 'kyra';
...
function showModal(contentHtml, isWide = false) {
    ...
    if (isWide) {
        ...
        modal.className =
            'bg-slate-900 border border-slate-800 rounded-2xl max-w-lg w-full p-6 shadow-2xl space-y-4';
    }
